...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                <ul class="menu">
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= base_url('assets/img/user/icon_user.png') ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?= base_url('assets/img/user/icon_user.png') ?>" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <form action="#" method="get" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="q" class="form-control" placeholder="Search Control Panel" autocomplete="off">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Control Panel <?= $title ?>
        <small>Blogpost Application</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= base_url('dashboard') ?>"><i class="fa fa-dashboard"></i> Control Panel</a></li>
